...
ts              = 2500                                           #Tile_size:  changing it can improve the performance. No fixed value can be given.
...
theta_out       = exageostat_emleR(n, ncores, gpus, ts, p_grid, q_grid,  vecs_out[1:n],  vecs_out[n+1:(2*n)],  vecs_out[(2*n+1):(3*n)], clb, cub, dmetric, 0.00000001, 10000)
